        ...
        ************   Notifications   ************
        ...
        app.addNotification = function (params) {
            ...
            var notificationTemplate = app.params.notificationTemplate || 
                ...
                '<li>{{custom}}</li>' +
                '{{else}}' +
                '<li class="notification-item notification-hidden" style="overflow-y:hidden;">' +
                    '<div class="item-content">' +
                        '{{#if material}}' +
                            '<div class="item-inner">' +
            ...
            item.on('click', function (e) {
                ...
                if (close) app.closeNotification(item[0], false);
            });
            if (params.onClose) {
            ...
            if (params.hold) {
                setTimeout(function () {
                    if (item.length > 0) app.closeNotification(item[0], true);
                }, params.hold);
            }
        ...
        app.closeNotification = function (item, auto) {
            item = $(item);
            if (item.length === 0) return;
